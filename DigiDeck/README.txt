This set of scripts uses Python to generate the necessary HTML, JS and Python code to create a local server that serves a soundboard page over your local area network. 
